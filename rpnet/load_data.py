...
class labelFpsDataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # fps = [[int(eel) for eel in el.split('and')] for el in iname[3].split('_')]
        ...
        [leftUp, rightDown] = [[int(eel) for eel in el.split('and')] for el in iname[2].split('_')]
...
class ChaLocDataLoader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # tps = [[int(eel) for eel in el.split('and')] for el in iname[2].split('_')]
        # for dot in tps:
