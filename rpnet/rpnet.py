...
if __name__=='__main__':
    ...
    ap.add_argument("-n", "--epochs", default=200,
    ...
    trainloader = DataLoader(dst, batch_size=batchSize, shuffle=True, num_workers=2)
    ...
    def eval(model, test_dirs):
        ...
        testloader = DataLoader(dst, batch_size=1, shuffle=True, num_workers=2)
        start = time()
